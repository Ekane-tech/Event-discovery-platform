...
export default function AdminUsersPage() {
  ...
  return <PageContainer><AdminHero title={t('admin.users.title', 'Manage users')} description={t('admin.users.description', 'Review accounts, roles and access status across the platform.')} />
    <div className="mt-6 grid grid-cols-2 gap-4 xl:grid-cols-4"><UserMetric label={t('admin.users.totalUsers', 'Total users')} value={metrics.total} icon={Users} gradient="from-indigo-600 to-blue-700" t={t}/><UserMetric label={t('admin.users.activeUsers', 'Active')} value={metrics.active} icon={UserCheck} gradient="from-blue-600 to-emerald-700" t={t}/><UserMetric label={t('admin.users.suspendedUsers', 'Suspended')} value={metrics.suspended} icon={UserX} gradient="from-rose-600 to-pink-700" t={t}/><UserMetric label={t('admin.users.organizersCount', 'Organizers')} value={metrics.organizers} icon={ShieldCheck} gradient="from-amber-500 to-orange-700" t={t}/></div>
