    ...
    <div>
      <section className="relative overflow-hidden bg-slate-950 text-white">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <span className="inline-flex items-center gap-2 rounded-full bg-white/10 px-4 py-2 text-sm font-bold text-teal-100 backdrop-blur"><Sparkles className="h-4 w-4" /> {t('events.browse.badge')}</span>
      ...
      <PageContainer>
        <div className="-mt-12 relative z-10 grid gap-5">
          ...
          {!loading && !error && filteredEvents.length === 0 && <EmptyState title={t('events.browse.emptyTitle')} message={t('events.browse.emptyMessage')} />}
