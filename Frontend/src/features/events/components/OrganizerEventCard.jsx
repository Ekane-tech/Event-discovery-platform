          ...
          <div className="flex flex-col gap-4 2xl:flex-row 2xl:items-start 2xl:justify-between">
            <div className="min-w-0 flex-1">
              <div className="mb-3 flex flex-wrap items-center gap-2">
                ...
                {isPast && <span className="inline-flex items-center gap-1 rounded-full bg-slate-900 px-3 py-1 text-xs font-black uppercase tracking-wide text-white"><Clock className="h-3 w-3" /> {t('events.card.pastEvent')}</span>}
              </div>
            ...
            <div className="grid shrink-0 grid-cols-2 gap-2 sm:flex sm:flex-wrap 2xl:max-w-[360px] 2xl:justify-end">
              <Link to={`/organizer/events/${event.id}/details`}><Button variant="secondary" className="w-full sm:w-auto">{t('details')}</Button></Link>
