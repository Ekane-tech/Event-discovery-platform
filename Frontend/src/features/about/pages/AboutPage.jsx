    ...
    <div>
      <section className="relative overflow-hidden bg-slate-950 text-white">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
          <span className="inline-flex items-center gap-2 rounded-full bg-white/10 px-4 py-2 text-sm font-bold text-teal-100"><Sparkles className="h-4 w-4" /> About the platform</span>
          <h1 className="mt-6 max-w-4xl text-5xl font-black leading-tight md:text-7xl">A smarter way to discover and manage events.</h1>
          <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-200">Event Discovery Platform connects attendees and organizers through personalized discovery, digital tickets, notifications and reliable event management.</p>
        ...
        <section className="mt-12 overflow-hidden rounded-3xl bg-white shadow-sm ring-1 ring-slate-200">
          <div className="grid lg:grid-cols-2">
            ...
            <div className="p-8 md:p-10">
              ...
              <p className="mt-4 leading-7 text-slate-600">The platform is designed around discovery and action: users choose interests, organizers publish events, and the system notifies the right audience when something relevant happens.</p>
